...
public partial class DbAb6b04HelloworldContext : DbContext
{
    public DbAb6b04HelloworldContext()
    {
    }

    public DbAb6b04HelloworldContext(DbContextOptions<DbAb6b04HelloworldContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=SQL1001.site4now.net;Initial Catalog=db_ab6b04_helloworld;Persist Security Info=True;User ID=db_ab6b04_helloworld_admin;Password=th689904;Encrypt=True;Trust Server Certificate=True");
